  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(100,217,140,0.12),transparent_34rem),linear-gradient(180deg,#0b100e,#070a09)] text-slate-100">
      ...
      <section className="lg:pl-64 pb-24 lg:pb-0">
        <header className="sticky top-0 z-20 border-b border-white/10 bg-[#090d0b]/90 px-4 py-4 backdrop-blur-xl sm:px-6 lg:px-8">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-30 flex items-center justify-between gap-2 bg-black/80 border-t border-white/10 px-4 py-3 backdrop-blur-xl lg:hidden">
        {navItems.map((item) => {
          const isActive = active === item.href;
          return (
            <Link
